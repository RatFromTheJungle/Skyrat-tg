#define PRICE_ENERGYGUN_CHEAP 400
#define PRICE_ENERGYGUN_EXPENSIVE 1000

#define PRICE_MCR_KIT 700
#define PRICE_MCR_PARTSBUNDLE 200
#define PRICE_MCR_ATTACHMENT 250
...
/datum/armament_entry/company_import/microstar/experimental_energy/ion_carbine
	...
	lower_cost = PRICE_ENERGYGUN_EXPENSIVE 
	upper_cost = PRICE_ENERGYGUN_EXPENSIVE * 1.2

/datum/armament_entry/company_import/microstar/experimental_energy/xray_gun
	item_type = /obj/item/gun/energy/xray
	lower_cost = PRICE_ENERGYGUN_EXPENSIVE * 3
	upper_cost = PRICE_ENERGYGUN_EXPENSIVE * 5
...
/datum/armament_entry/company_import/microstar/mcr_attachments/hellfire
	...
	lower_cost = PRICE_MCR_KIT
	upper_cost = PRICE_MCR_KIT * 3
	stock_mult = 2
...
/datum/armament_entry/company_import/microstar/mcr_upgrades/stabilizer
	...
	lower_cost = PRICE_MCR_ATTACHMENT * 0.5
	upper_cost = PRICE_MCR_ATTACHMENT
	stock_mult = 3
...
/datum/armament_entry/company_import/microstar/mcr_upgrades/enhanced_part_kit
	...
	lower_cost = PRICE_MCR_PARTSBUNDLE 
	upper_cost = PRICE_MCR_PARTSBUNDLE * 1.2
	stock_mult = 3
...
/datum/armament_entry/company_import/microstar/mcr_upgrades/capacity_booster
	...
	lower_cost = PRICE_MCR_ATTACHMENT
	upper_cost = PRICE_MCR_ATTACHMENT * 2
	interest_required = COMPANY_SOME_INTEREST
	stock_mult = 3
...
/datum/armament_entry/company_import/microstar/mcr_upgrades/advanced_part_kit
	...
	lower_cost = PRICE_MCR_PARTSBUNDLE * 1.5
	upper_cost = PRICE_MCR_PARTSBUNDLE * 3
	interest_required = COMPANY_SOME_INTEREST
	stock_mult = 3
...
/datum/armament_entry/company_import/microstar/mcr_upgrades/selfcharge
	...
	lower_cost = PRICE_MCR_ATTACHMENT * 2
	upper_cost = PRICE_MCR_ATTACHMENT * 4
...
/datum/armament_entry/company_import/microstar/mcr_upgrades/bluespace_part_kit
	...
	lower_cost = PRICE_MCR_PARTSBUNDLE * 5
	upper_cost = PRICE_MCR_PARTSBUNDLE * 7
	interest_required = COMPANY_HIGH_INTEREST
	stock_mult = 3
